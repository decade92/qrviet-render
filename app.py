...
# === UI ===
if "qr1" not in st.session_state:
...
uploaded_file = st.file_uploader("📤 Tải ảnh QR VietQR", type=["png", "jpg", "jpeg"], key="file")
if uploaded_file:
